...
<main>
    <div class="product-detail">
        <div>
            <img src="<?php echo $product['image'] ? SITE_URL . '/uploads/' . htmlspecialchars($product['image']) : SITE_URL . '/assets/img/placeholder.svg'; ?>" 
        ...
        <div class="meta">
            ...
            <button class="btn-buy" onclick="addAndGo(<?php echo $product['id']; ?>, '<?php echo htmlspecialchars(addslashes($product['name'])); ?>', <?php echo $product['price']; ?>)"
...
function addAndGo(id, name, price) {
    ...
    else cart.push({ id: id, name: name, price: price, quantity: qty });
